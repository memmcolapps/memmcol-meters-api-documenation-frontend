...
The API Management screens currently use seeded local state from
`src/app/adminApis.ts`. No API Management backend endpoints are connected yet.
...
- Route components keep temporary UI state such as search text and open modals.
