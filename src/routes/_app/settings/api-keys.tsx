...
const TEST_KEY = {
  name: "Test Key",
  secret: "powerhub_sb_test_51M-9f8e7d6c-5b4a-4321-a098-76543210fedc",
};
...
function ApiKeysPage() {
  ...
  useEffect(() => {
    if (!apiKeysQuery.error || notifiedError.current === apiKeysQuery.error)
      return;
  ...
  const activeKeys =
    apiKeysQuery.data?.items.filter((apiKey) => apiKey.status === "ACTIVE") ??
    [];
        ...
        <article className="key-card">
          ...
          <div className="key-row">
            <code className="key-value">
              {TEST_KEY.secret.substring(0, 20)}.......
              {TEST_KEY.secret.substring(53, TEST_KEY.secret.length)}
            </code>
            <button
              type="button"
            ...
            {step === "form" ? (
              ...
              <div className="modal-body">
                <p className="modal-text">
                  ...
                  <strong>Copy it now</strong>, as we will not display it again.
                </p>
                <div className="key-reveal">
                  <input
                    className="key-reveal-input"
