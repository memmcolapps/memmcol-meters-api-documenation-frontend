...
export const guides: ApiEntry[] = [
  {
    ...
    blurb:
      "How to add your meters to the Memmcol platform from your dashboard, which details each meter needs, and when SIM number and meter model are required.",
    sections: [
      {
        heading: "Before you start",
        body: "Meters are added from your dashboard, not through the API. Sign in first — every meter you add is registered to the organisation you are signed in to. Have the following ready for each meter.",
        items: [
          "The meter number.",
      ...
      },
      {
        ...
        body: "Go to Meters in the dashboard. The page lists every meter registered to your organisation, and lets you search by meter or SIM number, filter by status, and export the list as CSV.",
      },
      {
        heading: "Step 2 — Open the add meter form",
        body: 'Click Add Meters. The "Add new meter" form opens with the basic information fields.',
      },
      {
        heading: "Step 3 — Fill in the meter details",
        body: "The meter number and the key change values are required for every meter. SIM card number and meter model are optional — they are only needed when the meter is intended for HES use, as explained in the next section.",
        table: {
          ...
          rows: [
            [
              "Meter Number",
              "Yes",
              "Digits only. Must be unique — a meter number already registered on the platform is rejected.",
            ],
            [
              "Sim Card Number",
              "Only for HES use",
              "Digits only, and unique. The SIM the meter uses to reach the platform.",
            ],
            [
              "Meter Model",
              "Only for HES use",
              "Picked from the models already integrated with the platform, listed as model — manufacturer.",
            ],
            [
              "Old SGC / New SGC",
              "Yes",
              "Whole numbers. Supply Group Code before and after the key change.",
            ],
            [
              "Old KRN / New KRN",
              "Yes",
              "Whole numbers. Key Revision Number before and after the key change.",
            ],
            [
              "Old / New Tariff Index",
              "Yes",
              "Whole numbers. Tariff index before and after the key change.",
            ],
          ],
        },
      },
      ...
      },
      {
        ...
        body: "Click Add Meter. The meter is created and appears in the meter list. If the meter number or SIM card number already exists on the platform, the form flags the duplicate and nothing is created — check the value and try again.",
      },
      {
        heading: "After a meter is added",
        body: "From the meter list you can manage each meter as your setup changes.",
        items: [
    ...
    sections: [
      {
        ...
        body: "Review Supported Meter Models for HES to confirm whether your meter model is already allowed for HES use. If it is supported, proceed to Step 5. If it is not supported, continue to Step 2.",
      },
      {
        heading: "Step 2: Contact Our Team",
        body: "If your meter is not currently supported, contact our support team with the following information. This allows us to evaluate and integrate support for your meter.",
        items: [
          "Meter manufacturer",
          "Meter model",
          "Meter type",
      ...
      },
      {
        ...
        body: "Our engineering team will develop and validate support for your meter. Once the integration is complete, we will provide you with the required communication settings.",
        items: [
          "Server IP address",
          "Port number",
      ...
      },
      {
        ...
        body: "Using your meter's configuration software or interface, write the provided IP address, port, and any other required communication settings to the meter.",
      },
      {
        heading: "Step 5: Complete Onboarding",
        body: "After your meter has been successfully configured and connected to our platform, it will be onboarded for remote communication.",
      },
      {
        heading: "Step 6: Subscribe to the Service",
        body: "Choose a subscription plan to enable remote communication services for your meter.",
      },
      {
        heading: "Step 7: Start Using the APIs",
        body: "Follow the API documentation to work with your onboarded meter. Your meter is now ready for remote communication and API integration.",
        items: [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Every key belongs to one of two environments. Use a test key while you build and a live key in production. The two are independent — a test key never touches production data, and rotating one has no effect on the other.",
        table: {
          columns: ["Environment", "Use it for", "Key visibility"],
          rows: [
            [
              "TEST",
              "Development and trying calls from these docs",
              "Returned in full and viewable any time — it carries no production access",
            ],
            [
              "LIVE",
              "Real integrations and production traffic",
              "Shown once when created, then stored masked — copy it immediately",
            ],
          ],
        },
      },
      {
        ...
        body: "Generate keys from your dashboard. You do not need to call an API to get one.",
        items: [
      ...
      },
      {
        ...
        body: "Keys can be replaced or switched off at any time from Settings → API Keys. Rotate on a schedule, and revoke immediately if a key is ever exposed.",
        items: [
      ...
      },
      {
        ...
        body: "An API key grants access to your organisation’s meters and data. Treat it like a password.",
        items: [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Keep your key out of your command history and code by exporting it as an environment variable for the session.",
        code: 'export MOMAS_API_KEY="<YOUR_TEST_API_KEY>"',
      },
      {
      ...
      },
      {
        ...
        body: "A successful call returns 200 with a JSON body. A 401 means the key is missing, revoked, or expired; a 404 means the endpoint or resource path is wrong. The exact response shape for each API is documented on its reference page under Sample Response.",
      ...
      {
        heading: "Next steps",
        body: "That is a complete authenticated request. From here, browse the APIs on the documentation home page to see every available endpoint, its route, cost, and sample payloads.",
        items: [
...
if (import.meta.env.DEV) {
  ...
  for (const entry of [...apis, ...guides]) {
    if (seen.has(entry.slug)) {
      console.warn(
        `[apis] Duplicate doc slug "${entry.slug}" — slugs must be unique.`,
      );
    }
    seen.add(entry.slug);
  }
